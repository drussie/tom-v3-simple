...
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT ?= .data/contracts/controlled_runtime_calibration_post_reexecution_verification_not_available_packet_contract_v1.json
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_INPUTS_OUTPUT ?= .data/exports/controlled_runtime_calibration_post_reexecution_verification_inputs.current.json
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_INPUTS ?= $(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_INPUTS_OUTPUT)
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_INPUTS_VALIDATION_OUTPUT ?= .data/exports/controlled_runtime_calibration_post_reexecution_verification_inputs.validation.json
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_OUTPUT ?= .data/contracts/controlled_runtime_calibration_post_reexecution_verification_not_available_packet_v1.json
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET ?= $(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_OUTPUT)
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_VALIDATION_OUTPUT ?= .data/exports/controlled_runtime_calibration_post_reexecution_verification_not_available_packet.validation.json
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_AVAILABILITY_REPORT_OUTPUT ?= .data/exports/controlled_runtime_calibration_post_reexecution_verification_availability_report.current.json
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_MISSING_EXECUTION_EVIDENCE_REPORT_OUTPUT ?= .data/exports/controlled_runtime_calibration_post_reexecution_missing_execution_evidence_report.current.json
...
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_SOURCE_REEXECUTION_EXECUTION_BLOCKED_RESULT ?= $(CONTROLLED_RUNTIME_CALIBRATION_REEXECUTION_EXECUTION_BLOCKED_RESULT_OUTPUT)
CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_SOURCE_REEXECUTION_EXECUTION_BLOCKED_RESULT_CONTRACT ?= $(CONTROLLED_RUNTIME_CALIBRATION_REEXECUTION_EXECUTION_BLOCKED_RESULT_CONTRACT_OUTPUT)
...
tom-v1-export-controlled-runtime-calibration-post-reexecution-verification-not-available-packet-contract:
	$(PYTHON) -m apps.worker.cli export-controlled-runtime-calibration-post-reexecution-verification-not-available-packet-contract --output "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT)" --skip-create-db

tom-v1-build-controlled-runtime-calibration-post-reexecution-verification-inputs:
	$(PYTHON) -m apps.worker.cli build-controlled-runtime-calibration-post-reexecution-verification-inputs --contract "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT)" --source-reexecution-execution-blocked-result "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_SOURCE_REEXECUTION_EXECUTION_BLOCKED_RESULT)" --source-reexecution-execution-blocked-result-contract "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_SOURCE_REEXECUTION_EXECUTION_BLOCKED_RESULT_CONTRACT)" --model-asset-path "$(GAMEPLAY_CLASSIFIER_ASSET_PATH)" --output "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_INPUTS_OUTPUT)" --skip-create-db

tom-v1-validate-controlled-runtime-calibration-post-reexecution-verification-inputs:
	$(PYTHON) -m apps.worker.cli validate-controlled-runtime-calibration-post-reexecution-verification-inputs --contract "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT)" --post-reexecution-verification-inputs "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_INPUTS)" --output "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_INPUTS_VALIDATION_OUTPUT)" --skip-create-db

tom-v1-build-controlled-runtime-calibration-post-reexecution-verification-not-available-packet:
	$(PYTHON) -m apps.worker.cli build-controlled-runtime-calibration-post-reexecution-verification-not-available-packet --contract "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT)" --post-reexecution-verification-inputs "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_INPUTS)" --output "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_OUTPUT)" --skip-create-db

tom-v1-validate-controlled-runtime-calibration-post-reexecution-verification-not-available-packet:
	$(PYTHON) -m apps.worker.cli validate-controlled-runtime-calibration-post-reexecution-verification-not-available-packet --contract "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT)" --post-reexecution-verification-not-available-packet "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET)" --output "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_VALIDATION_OUTPUT)" --skip-create-db

tom-v1-build-controlled-runtime-calibration-post-reexecution-verification-availability-report:
	$(PYTHON) -m apps.worker.cli build-controlled-runtime-calibration-post-reexecution-verification-availability-report --contract "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT)" --post-reexecution-verification-not-available-packet "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET)" --output "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_AVAILABILITY_REPORT_OUTPUT)" --skip-create-db

tom-v1-build-controlled-runtime-calibration-post-reexecution-missing-execution-evidence-report:
	$(PYTHON) -m apps.worker.cli build-controlled-runtime-calibration-post-reexecution-missing-execution-evidence-report --contract "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT)" --post-reexecution-verification-not-available-packet "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET)" --output "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_MISSING_EXECUTION_EVIDENCE_REPORT_OUTPUT)" --skip-create-db

tom-v1-build-controlled-runtime-calibration-post-reexecution-runtime-non-mutation-evidence-report:
	$(PYTHON) -m apps.worker.cli build-controlled-runtime-calibration-post-reexecution-runtime-non-mutation-evidence-report --contract "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT)" --post-reexecution-verification-not-available-packet "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET)" --output "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_RUNTIME_NON_MUTATION_EVIDENCE_REPORT_OUTPUT)" --skip-create-db

tom-v1-build-controlled-runtime-calibration-post-reexecution-final-gate-dependency-report:
	$(PYTHON) -m apps.worker.cli build-controlled-runtime-calibration-post-reexecution-final-gate-dependency-report --contract "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET_CONTRACT_OUTPUT)" --post-reexecution-verification-not-available-packet "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_VERIFICATION_NOT_AVAILABLE_PACKET)" --output "$(CONTROLLED_RUNTIME_CALIBRATION_POST_REEXECUTION_FINAL_GATE_DEPENDENCY_REPORT_OUTPUT)" --skip-create-db
