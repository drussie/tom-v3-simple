...
- Current phase: Blueprint 50 complete; review-guided gameplay calibration evaluation sandbox v1 added
- Current goal: Preserve the BP22-BP36 structural expansion freeze, keep protected regression
  ...
  metrics/dashboard layer, proposal-only calibration planning surface, and offline-only
  calibration evaluation sandbox without creating tennis truth
