...
Milestone 6A started Blueprint 6. Milestone 6B adds detection overlay playback.
...
Future modes may explore stream proxy workflows, but production live ingestion is not part of 6A or 6B.
