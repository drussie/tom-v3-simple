...
artifact state, then explicit selected candidate artifact state. The current path remains blocked
until real operator signoff identity, attestation, timestamp, explicit selected candidate context,
and a future final-gate rerun exist.
