...
run "$PYTHON_BIN" -m apps.worker.cli export-controlled-runtime-calibration-blocked-execution-resolution-packet-contract \
  --output "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-blocked-execution-resolution-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --source-application-execution-review-packet "$TMP_ROOT/controlled_runtime_calibration_application_execution_review_packet.current.json" \
  --source-application-execution-review-packet-contract "$TMP_ROOT/controlled_runtime_calibration_application_execution_review_packet_contract_v1.smoke.json" \
  --model-asset-path "model_assets/tom_v1/view_classifier_gameplay.pt" \
  --output "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_inputs.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-blocked-execution-resolution-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --resolution-packet-inputs "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_inputs.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-blocked-execution-resolution-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --resolution-packet-inputs "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-blocked-execution-resolution-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --resolution-packet "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-blocker-resolution-checklist \
  --contract "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --resolution-packet "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_blocker_resolution_checklist.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-operator-action-plan \
  --contract "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --resolution-packet "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_operator_action_plan.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-candidate-selection-requirements \
  --contract "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --resolution-packet "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_candidate_selection_requirements.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-final-gate-rerun-plan \
  --contract "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --resolution-packet "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_plan.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-reexecution-readiness-plan \
  --contract "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet_contract_v1.smoke.json" \
  --resolution-packet "$TMP_ROOT/controlled_runtime_calibration_blocked_execution_resolution_packet.current.json" \
...
run "$PYTHON_BIN" -m apps.worker.cli export-controlled-runtime-calibration-explicit-operator-signoff-artifact-contract \
  --output "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_contract_v1.smoke.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-explicit-operator-signoff-artifact-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_contract_v1.smoke.json" \
  ...
  --model-asset-path "model_assets/tom_v1/view_classifier_gameplay.pt" \
  --output "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_inputs.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-explicit-operator-signoff-artifact-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_contract_v1.smoke.json" \
  --signoff-inputs "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_inputs.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-explicit-operator-signoff-artifact \
  --contract "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_contract_v1.smoke.json" \
  --signoff-inputs "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-explicit-operator-signoff-artifact \
  --contract "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_contract_v1.smoke.json" \
  --signoff-artifact "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-operator-signoff-requirements-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_contract_v1.smoke.json" \
  --signoff-artifact "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_operator_signoff_requirements_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-operator-attestation-template \
  --contract "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_contract_v1.smoke.json" \
  --signoff-artifact "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_operator_attestation_template.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-operator-signoff-readiness-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_contract_v1.smoke.json" \
  --signoff-artifact "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact.current.json" \
...
run "$PYTHON_BIN" -m apps.worker.cli export-controlled-runtime-calibration-human-resolution-input-packet-contract \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-input-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --source-explicit-selected-candidate-artifact "$TMP_ROOT/controlled_runtime_calibration_explicit_selected_candidate_artifact.current.json" \
  --source-explicit-selected-candidate-artifact-contract "$TMP_ROOT/controlled_runtime_calibration_explicit_selected_candidate_artifact_contract_v1.smoke.json" \
  --source-explicit-operator-signoff-artifact "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact.current.json" \
  --source-explicit-operator-signoff-artifact-contract "$TMP_ROOT/controlled_runtime_calibration_explicit_operator_signoff_artifact_contract_v1.smoke.json" \
  --source-operator-signoff-candidate-selection-packet "$TMP_ROOT/controlled_runtime_calibration_operator_signoff_candidate_selection_packet.current.json" \
  --source-operator-signoff-candidate-selection-packet-contract "$TMP_ROOT/controlled_runtime_calibration_operator_signoff_candidate_selection_packet_contract_v1.smoke.json" \
  --model-asset-path "model_assets/tom_v1/view_classifier_gameplay.pt" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_inputs.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-human-resolution-input-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --human-resolution-inputs "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_inputs.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-input-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --human-resolution-inputs "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-human-resolution-input-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --human-resolution-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-requirements-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --human-resolution-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_requirements_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-input-template \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --human-resolution-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_template.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-readiness-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --human-resolution-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_readiness_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-final-gate-rerun-prerequisite-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --human-resolution-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_prerequisite_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli export-controlled-runtime-calibration-human-resolution-provided-packet-contract \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_contract_v1.smoke.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-provided-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_contract_v1.smoke.json" \
  --source-human-resolution-input-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet.current.json" \
  --source-human-resolution-input-packet-contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_input_packet_contract_v1.smoke.json" \
  --model-asset-path "model_assets/tom_v1/view_classifier_gameplay.pt" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_inputs.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-human-resolution-provided-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_contract_v1.smoke.json" \
  --human-resolution-provided-inputs "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_inputs.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-provided-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_contract_v1.smoke.json" \
  --human-resolution-provided-inputs "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-human-resolution-provided-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_contract_v1.smoke.json" \
  --human-resolution-provided-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-missing-input-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_contract_v1.smoke.json" \
  --human-resolution-provided-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_missing_input_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-completeness-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_contract_v1.smoke.json" \
  --human-resolution-provided-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_completeness_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-final-gate-readiness-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_contract_v1.smoke.json" \
  --human-resolution-provided-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_human_resolution_final_gate_readiness_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-human-resolution-reexecution-readiness-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet_contract_v1.smoke.json" \
  --human-resolution-provided-packet "$TMP_ROOT/controlled_runtime_calibration_human_resolution_provided_packet.current.json" \
...
run "$PYTHON_BIN" -m apps.worker.cli export-controlled-runtime-calibration-final-gate-rerun-request-packet-contract \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_contract_v1.smoke.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-final-gate-rerun-request-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_contract_v1.smoke.json" \
  --source-human-resolution-completeness-gate "$TMP_ROOT/controlled_runtime_calibration_human_resolution_completeness_gate.current.json" \
  --source-human-resolution-completeness-gate-contract "$TMP_ROOT/controlled_runtime_calibration_human_resolution_completeness_gate_contract_v1.smoke.json" \
  --model-asset-path "model_assets/tom_v1/view_classifier_gameplay.pt" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_inputs.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-final-gate-rerun-request-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_contract_v1.smoke.json" \
  --final-gate-rerun-request-packet-inputs "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_inputs.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-final-gate-rerun-request-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_contract_v1.smoke.json" \
  --final-gate-rerun-request-packet-inputs "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-final-gate-rerun-request-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_contract_v1.smoke.json" \
  --final-gate-rerun-request-packet "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-final-gate-rerun-request-blocker-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_contract_v1.smoke.json" \
  --final-gate-rerun-request-packet "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_blocker_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-final-gate-rerun-request-prerequisite-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_contract_v1.smoke.json" \
  --final-gate-rerun-request-packet "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_prerequisite_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-final-gate-rerun-execution-plan \
  --contract "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_contract_v1.smoke.json" \
  --final-gate-rerun-request-packet "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_execution_plan.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-final-gate-rerun-reexecution-dependency-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet_contract_v1.smoke.json" \
  --final-gate-rerun-request-packet "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_request_packet.current.json" \
...
run "$PYTHON_BIN" -m apps.worker.cli export-controlled-runtime-calibration-reexecution-request-packet-contract \
  --output "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-reexecution-request-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --source-final-gate-rerun-execution-blocked-result "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_execution_blocked_result.current.json" \
  --source-final-gate-rerun-execution-blocked-result-contract "$TMP_ROOT/controlled_runtime_calibration_final_gate_rerun_execution_blocked_result_contract_v1.smoke.json" \
  --model-asset-path "model_assets/tom_v1/view_classifier_gameplay.pt" \
  --output "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_inputs.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-reexecution-request-packet-inputs \
  --contract "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --reexecution-request-packet-inputs "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_inputs.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-reexecution-request-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --reexecution-request-packet-inputs "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_inputs.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli validate-controlled-runtime-calibration-reexecution-request-packet \
  --contract "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --reexecution-request-packet "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet.validation.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-reexecution-request-blocker-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --reexecution-request-packet "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_blocker_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-reexecution-prerequisite-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --reexecution-request-packet "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_reexecution_prerequisite_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-final-gate-dependency-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --reexecution-request-packet "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_final_gate_dependency_report.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-reexecution-execution-plan \
  --contract "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --reexecution-request-packet "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet.current.json" \
  --output "$TMP_ROOT/controlled_runtime_calibration_reexecution_execution_plan.current.json" \
  --skip-create-db

run "$PYTHON_BIN" -m apps.worker.cli build-controlled-runtime-calibration-reexecution-runtime-mutation-prevention-report \
  --contract "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet_contract_v1.smoke.json" \
  --reexecution-request-packet "$TMP_ROOT/controlled_runtime_calibration_reexecution_request_packet.current.json" \
